 ...
 */
public class NewUserVisitor extends ButtonVisitor{

    private TextFieldWidjet textFieldWidjet;
    private TextLabelWidjet textLabelWidjet;

    public NewUserVisitor(TextFieldWidjet t, TextLabelWidjet te){
        textFieldWidjet = t;
        textLabelWidjet = te;
    }
    ...
    public ActionListener onClickAction() {
        return new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                UserManagerSingleton.getInstance().addUser(tempField.getText());
            }
        };
    }
}
